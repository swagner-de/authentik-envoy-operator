...
*/}}
{{- define "authentik-envoy-operator.name" -}}
...
*/}}
{{- define "authentik-envoy-operator.fullname" -}}
...
*/}}
{{- define "authentik-envoy-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "authentik-envoy-operator.resourceName" -}}
{{- $fullname := include "authentik-envoy-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "authentik-envoy-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "authentik-envoy-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
